...
# Cria um publisher para publicar as coordenadas do centro e as dimensões do objeto
pub = rospy.Publisher("object_info", Quaternion, queue_size=1)
...
def image_callback(msg):
    try:
        ...
        if len(contours) > 0:
            ...
            # Publica as informações do objeto
            obj_info = Quaternion()
            obj_info.x = cx
            obj_info.y = cy
            obj_info.z = w
